...
Plan, position, and execute product launches. Full launch planning, offer positioning, email sequences, and nurture campaigns — built for solopreneurs and creators launching products, memberships, courses, and services.
...
Works standalone with any email platform. Connecting **Kit** unlocks analytics-informed writing. See `references/connectors.md` for details.
