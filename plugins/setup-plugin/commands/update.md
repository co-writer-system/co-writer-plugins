---
description: Audit your CLAUDE.md and workspace, then walk through targeted updates — keeps your system current as things change.
---
...
|-----------------|----------------|
| Principles | How Claude should behave, working rules |
| Your Lane | What Claude handles, main use cases |
...
| Voice & Style | Writing style, tone, words to use/avoid |
| Workspace Structure | Folder layout documentation |
| Boundaries | What needs human approval, confidentiality rules |
...
| Tools | Good | — |
| Voice & Style | Missing | No writing style documented |
...
- **ICP** — missing the "How They Talk About It" part (the actual words your customers use)
- **Voice & Style** — no writing style documented yet
...
After writing, update the timestamp at the bottom of the file:

```markdown
<!-- Last updated: YYYY-MM-DD via /setup:update -->
```
...
- **Translate errors** — if a folder can't be created or a file can't be written, explain in plain language what went wrong and what the user can do about it
